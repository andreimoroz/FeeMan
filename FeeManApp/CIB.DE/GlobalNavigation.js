...
CIB.DE.navigation = function () {
    ...
    var getDeleteLink = function () {
        ...
        deleteLink.click(function () {
            ...
            var list = ctx.host.get_web().get_lists().getByTitle('App Navigation Links');
    ...
    return {
        ...
        load: function () {
            ...
            if (CIB.DE.navigation.globalLinks.length == 0 && ($.hasAppWeb() || $.isInternetExplorer())) {
                ...
                if (navigationache.containsValue()) {
                    ...
                    var scope = $.handleExceptionsScope(ctx.context, function () {
                        ...
                        ctx.context.load(links, 'Include(ID, Title, Link_x0020_Url)');
                    });
                ...
                for (var index in CIB.DE.navigation.globalLinks) {
                    var link = CIB.DE.navigation.globalLinks[index];
